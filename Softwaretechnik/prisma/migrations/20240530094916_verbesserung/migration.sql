/*
  ...
  - You are about to drop the column `breakfast` on the `foods` table. All the data in the column will be lost.
  - You are about to drop the column `dinner` on the `foods` table. All the data in the column will be lost.
  - You are about to drop the column `lunch` on the `foods` table. All the data in the column will be lost.
  - You are about to drop the column `breakfast` on the `Meals` table. All the data in the column will be lost.
  - You are about to drop the column `dinner` on the `Meals` table. All the data in the column will be lost.
  - You are about to drop the column `lunch` on the `Meals` table. All the data in the column will be lost.
