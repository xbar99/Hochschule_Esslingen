...
Datum::Datum(const string& datum) {
    ...
    ss >> tag >> punkt >> monat >> punkt >> jahr;
}

// hier Konvertierkonstruktor für C-String
Datum::Datum(const char* datum) {
    string datumChar(datum);

    stringstream ss(datumChar);
...
int main(int argc, char *argv[]) 
{
    ...
    // Medien ausleihen
    bib.mediumAusleihen(1, p1, "4.5.2023"); //3.5.2022
    bib.mediumAusleihen(7, p2, "25.5.2023"); //17.10.2022
    bib.mediumAusleihen(4, p3, "12.10.2023"); //8.12.2022
    // Bestand der Bibliothek ausgeben
    bib.print();
}